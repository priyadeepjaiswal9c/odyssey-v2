  ...
  return (
    <group>
      <group position={pos}>
        ...
        {/* every trade signed — mounted on its building's face */}
        <Sign text="WINDFLOW" sub="AI Intern" position={[-10, EXP_TOP + 6.6, -7.4]} size={0.62} />
        <Sign text="IIT PATNA" sub="B.Tech ECE" position={[13, EXP_TOP + 5.4, -8.4]} size={0.62} />
        <Sign text="TEDX" sub="Speaker · Organizer" position={[-14, EXP_TOP + 7.4, 14.2]} size={0.55} />
        <Sign text="YAVANIKA" sub="Dramatics" position={[1, EXP_TOP + 7.6, 19.6]} size={0.6} />
        <Sign text="NSS" sub="Community Service" position={[16, EXP_TOP + 4.6, 14.6]} size={0.55} />
      </group>
